...
public class DagingActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting nama produk
        foodName.setText("Paket Daging");
        imageView.setImageResource(R.drawable.daging);
        description.setText("Paket daging isi 10 slice");
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DagingActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int basePrice=10000;
                if(quantity == 0){
                    Toast.makeText(DagingActivity.this, "Tidak bisa kurang dari 0", Toast.LENGTH_SHORT).show();
                }else{
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
