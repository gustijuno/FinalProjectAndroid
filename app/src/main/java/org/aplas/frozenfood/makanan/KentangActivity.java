...
public class KentangActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting nama produk
        foodName.setText("Kentang");
        imageView.setImageResource(R.drawable.kentang);
        description.setText("Kentang");
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(KentangActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int basePrice=10000;
                if(quantity == 0){
                    Toast.makeText(KentangActivity.this, "Tidak bisa kurang dari 0", Toast.LENGTH_SHORT).show();
                }else{
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
