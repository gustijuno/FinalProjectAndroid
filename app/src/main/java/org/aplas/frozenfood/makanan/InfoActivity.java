...
public class InfoActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    TextView quantitynumber, foodName, productPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int basePrice=10000;
                if(quantity == 0){
                    Toast.makeText(InfoActivity.this, "Tidak bisa kurang dari 0", Toast.LENGTH_SHORT).show();
                }else{
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
