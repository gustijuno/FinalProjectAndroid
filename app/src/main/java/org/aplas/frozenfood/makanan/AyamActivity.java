...
public class AyamActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting nama produk
        foodName.setText("Paket Ayam");
        imageView.setImageResource(R.drawable.ayam);
        description.setText("Paket ayam isi 10 slice daging");
        ...
        addtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AyamActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int basePrice=10000;
                if(quantity == 0){
                    Toast.makeText(AyamActivity.this, "Tidak bisa kurang dari 0", Toast.LENGTH_SHORT).show();
                }else{
                    quantity--;
                    displayQuantity();
                    int productsPrice = basePrice * quantity;
